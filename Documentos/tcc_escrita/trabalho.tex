...
\begin{figure}[htb]
    ...
    \fig{scale=0.8}{imagens/automatos/state2}
    \fonte{O próprio autor}
\end{figure}
...
\begin{figure}[htb]
    ...
    \fig{scale=1.0}{imagens/automatos/state7}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato ativo estado 8}
    \fig{scale=1.0}{imagens/automatos/state8}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato ativo estado 9}
    \fig{scale=0.8}{imagens/automatos/state9}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato ativo estado 10}
    \fig{scale=0.8}{imagens/automatos/state10}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato ativo estado 11}
    \fig{scale=0.8}{imagens/automatos/state11}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato ativo estado 12}
    \fig{scale=0.8}{imagens/automatos/state12}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato ativo estado 13}
    \fig{scale=0.8}{imagens/automatos/state13}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato ativo estado 14}
    \fig{scale=0.8}{imagens/automatos/state14}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato ativo estado 15}
    \fig{scale=0.8}{imagens/automatos/state15}
    \fonte{O próprio autor}
\end{figure}
...
\begin{figure}[htb]
    ...
    \fig{scale=0.8}{imagens/automatos/stateDisabled2}
    \fonte{O próprio autor}
\end{figure}
...
\begin{figure}[htb]
    ...
    \fig{scale=0.8}{imagens/automatos/stateDisabled8}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato desabilitado estado 9}
    \fig{scale=0.8}{imagens/automatos/stateDisabled9}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato desabilitado estado 10}
    \fig{scale=0.8}{imagens/automatos/stateDisabled10}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato desabilitado estado 11}
    \fig{scale=0.8}{imagens/automatos/stateDisabled11}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato desabilitado estado 12}
    \fig{scale=0.8}{imagens/automatos/stateDisabled12}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato desabilitado estado 13}
    \fig{scale=0.8}{imagens/automatos/stateDisabled13}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato desabilitado estado 14}
    \fig{scale=0.8}{imagens/automatos/stateDisabled14}
    \fonte{O próprio autor}
\end{figure}

\begin{figure}[htb]
    \legenda[fig:figura]{Autômato desabilitado estado 15}
    \fig{scale=0.8}{imagens/automatos/stateDisabled15}
    \fonte{O próprio autor}
\end{figure}
