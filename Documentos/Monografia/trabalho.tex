...
\begin{figure}[htb]
    \legenda[fig:figura]{Funcionamento de um Compilador}
...
\begin{grafico}[H]
    \legenda[fig:grafico]{Gráfico de auxílio do interpretador}
...
\includegraphics[scale=0.8, clip,trim=10mm 10mm 0mm 10mm, angle=-90, page=2]{QUESTIONARIO.pdf}

\includegraphics[scale=0.8, clip,trim=10mm 10mm 0mm 10mm, angle=-90, page=3]{QUESTIONARIO.pdf}
